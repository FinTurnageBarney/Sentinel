...
folder_paths <- list.files(path = "Data/Scenes/2018_2019/MNDWI_Scenes/Cloudcover40", full.names = TRUE)
...
Water_area_per_Scene <-  lapply(folder_paths, function(folder_path){
  ...
  ggsave(paste0("Result_Excel/MNDWI/Triple_Plots/2018_2019/",keep_date(folder_path),".PNG"), combined_grob, width = 20, height = 10)
